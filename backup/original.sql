...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Дек 24 2017 г., 14:47
...
INSERT INTO `attribute_value` (`id`, `name`, `attribute_id`) VALUES
(1, 'Сладкий', 1),
(2, 'Морской', 1),
(3, 'Ветивер', 4),
(4, 'Ваниль', 4),
...
INSERT INTO `brand` (`id`, `name`, `image`, `description`, `slug`) VALUES
...
INSERT INTO `carousel` (`id`, `name`, `image`, `caption`) VALUES
(6, 'Первый слайд', '1513105751.jpg', '');
...
INSERT INTO `category` (`id`, `name`, `description`, `parent_id`, `slug`, `image`, `status`, `meta`, `date_publish`, `date_update`) VALUES
...
INSERT INTO `product` (`id`, `name`, `description`, `slug`, `meta`, `tags`, `brand_id`, `sku`, `price`, `quantity`, `image`, `stock_status_id`, `active`, `date_publish`, `date_update`) VALUES
(130, 'ADIDAS CHAMPIONS LEAGUE (ARENA EDITION) для мужчин', NULL, 'adidas-champions-league-arena-edition-dlya-muzhchin-11', NULL, NULL, 2, NULL, NULL, NULL, 'ADIDAS_CHAMPIONS_LEAGUE_(ARENA_EDITION)_dlja_muzhchin_100_ml_tualetnaja_voda_(edt)_.jpg', 1, 0, '2017-12-20 00:10:31', '2017-12-20 00:10:31'),
(131, 'ADIDAS CHAMPIONS LEAGUE (STAR EDITION) для мужчин', '<p>Аромат ночной свежести и приключений. Он создаст вашу личную легенду. Это магическая сила, стремящаяся завоевать каждого, кто встретится на ее пути. Таинство и волшебство окутывает обладательницу этой завораживающей парфюмерии. Она опьяняет и призывно манит в свои сети, приглашая на праздник для двоих. Она достаточно опытна, чтобы завоевать мужчину и навеки удержать его рядом. Ноты нарцисса, меда и гиацинта, черной смородины, тубероза и бергамота, розы, пачули, ветивера и малины играют на струнах сердца незабываемую мелодию Magie Noire. Услышав ее только раз, вас будут помнить вечно.</p>\r\n', 'adidas-champions-league-star-edition-dlya-muzhchin', 'a:3:{s:14:"meta_tag_title";s:0:"";s:20:"meta_tag_description";s:0:"";s:17:"meta_tag_keywords";s:0:"";}', 's:0:"";', 2, '', NULL, NULL, 'ADIDAS_CHAMPIONS_LEAGUE_(STAR_EDITION)_dlja_muzhchin_100_ml_tualetnaja_voda_(edt)_.jpg', 1, 0, '2017-12-20 00:13:56', '2017-12-20 13:48:17'),
(132, 'ADIDAS Dynamic Pulse для мужчин', NULL, 'adidas-dynamic-pulse-dlya-muzhchin', NULL, NULL, 2, NULL, NULL, NULL, 'ADIDAS_Dynamic_Pulse_dlja_muzhchin_100_ml_tualetnaja_voda_(edt)_.jpg', 1, 0, '2017-12-20 00:13:56', '2017-12-20 00:13:56'),
(133, 'ADIDAS Extreme Power (SPECIAL EDITION) для мужчин', NULL, 'adidas-extreme-power-special-edition-dlya-muzhchin', NULL, NULL, 2, NULL, NULL, NULL, 'ADIDAS_Extreme_Power_(SPECIAL_EDITION)_dlja_muzhchin_100_ml_tualetnaja_voda_(edt)_.jpg', 1, 0, '2017-12-20 00:13:56', '2017-12-20 00:13:56'),
(134, 'ADIDAS Extreme Power для мужчин', NULL, 'adidas-extreme-power-dlya-muzhchin', NULL, NULL, 2, NULL, NULL, NULL, 'ADIDAS_Extreme_Power_dlja_muzhchin_100_ml_tualetnaja_voda_(edt)_.jpg', 1, 0, '2017-12-20 00:13:56', '2017-12-20 00:13:56'),
(135, 'ADIDAS Fruity Rhythm для женщин', NULL, 'adidas-fruity-rhythm-dlya-zhenshchin', NULL, NULL, 2, NULL, NULL, NULL, 'ADIDAS_Fruity_Rhythm_dlja_zhenshhin_50_ml_tualetnaja_voda_(edt)_.jpg', 1, 0, '2017-12-20 00:13:56', '2017-12-20 00:13:56'),
(136, 'ADIDAS Get Ready для мужчин', NULL, 'adidas-get-ready-dlya-muzhchin', NULL, NULL, 2, NULL, NULL, NULL, 'ADIDAS_Get_Ready_dlja_muzhchin_100_ml_tualetnaja_voda_(edt)_.jpg', 1, 0, '2017-12-20 00:13:56', '2017-12-20 00:13:56'),
(137, 'ADIDAS Ice Dive для мужчин', NULL, 'adidas-ice-dive-dlya-muzhchin', NULL, NULL, 2, NULL, NULL, NULL, 'ADIDAS_Ice_Dive_dlja_muzhchin_100_ml_tualetnaja_voda_(edt)_.jpg', 1, 0, '2017-12-20 00:13:56', '2017-12-20 00:13:56'),
(138, 'ADIDAS Intense Touch для мужчин', NULL, 'adidas-intense-touch-dlya-muzhchin', NULL, NULL, 2, NULL, NULL, NULL, 'ADIDAS_Intense_Touch_dlja_muzhchin_100_ml_tualetnaja_voda_(edt)_.jpg', 1, 0, '2017-12-20 00:13:56', '2017-12-20 00:13:56'),
(139, 'ADIDAS Natural Vitality для женщин', NULL, 'adidas-natural-vitality-dlya-zhenshchin', NULL, NULL, 2, NULL, NULL, NULL, 'ADIDAS_Natural_Vitality_dlja_zhenshhin_50_ml_tualetnaja_voda_(edt)_.jpg', 1, 0, '2017-12-20 00:13:56', '2017-12-20 00:13:56'),
(140, 'ADIDAS Pure Game для мужчин', NULL, 'adidas-pure-game-dlya-muzhchin', NULL, NULL, 2, NULL, NULL, NULL, 'ADIDAS_Pure_Game_dlja_muzhchin_100_ml_tualetnaja_voda_(edt)_.jpg', 1, 0, '2017-12-20 00:13:56', '2017-12-20 00:13:56'),
(141, 'ADIDAS Pure Lightness для женщин', NULL, 'adidas-pure-lightness-dlya-zhenshchin', NULL, NULL, 2, NULL, NULL, NULL, 'ADIDAS_Pure_Lightness_dlja_zhenshhin_50_ml_tualetnaja_voda_(edt)_.jpg', 1, 0, '2017-12-20 00:13:56', '2017-12-20 00:13:56'),
(142, 'ADIDAS Team Five Special Edition для мужчин', NULL, 'adidas-team-five-special-edition-dlya-muzhchin', NULL, NULL, 2, NULL, NULL, NULL, 'ADIDAS_Team_Five_Special_Edition_dlja_muzhchin_100_ml_tualetnaja_voda_(edt)_.jpg', 1, 0, '2017-12-20 00:13:56', '2017-12-20 00:13:56'),
(143, 'ADIDAS Team Five Special Edition для мужчин', NULL, 'adidas-team-five-special-edition-dlya-muzhchin-2', NULL, NULL, 2, NULL, NULL, NULL, 'ADIDAS_Team_Five_dlja_muzhchin_50_ml_tualetnaja_voda_(edt)_.jpg', 1, 0, '2017-12-20 00:13:56', '2017-12-20 00:13:56'),
(144, 'ADIDAS Team Force для мужчин', NULL, 'adidas-team-force-dlya-muzhchin', NULL, NULL, 2, NULL, NULL, NULL, 'ADIDAS_Team_Force_dlja_muzhchin_50_ml_tualetnaja_voda_(edt)_.jpg', 1, 0, '2017-12-20 00:13:56', '2017-12-20 00:13:56'),
(145, 'ADIDAS Victory League для мужчин', NULL, 'adidas-victory-league-dlya-muzhchin', NULL, NULL, 2, NULL, NULL, NULL, 'ADIDAS_Victory_League_dlja_muzhchin_50_ml_tualetnaja_voda_(edt)_.jpg', 1, 0, '2017-12-20 00:13:56', '2017-12-20 00:13:56'),
(146, 'AFFINESSENCE CEDRE-IRIS унисекс', NULL, 'affinessence-cedre-iris-uniseks', NULL, NULL, 3, NULL, NULL, NULL, 'AFFINESSENCE_CEDRE-IRIS_uniseks_100_ml_parfjumernaja_voda_(EDP)_.jpg', 1, 0, '2017-12-20 00:13:56', '2017-12-20 00:13:56');

-- --------------------------------------------------------

--
-- Структура таблицы `product_attribut`
--

CREATE TABLE IF NOT EXISTS `product_attribut` (
  `id` int(11) NOT NULL,
...
--
-- Дамп данных таблицы `product_attribut`
--

INSERT INTO `product_attribut` (`id`, `product_id`, `attribut_id`, `attribu_value_id`) VALUES
(1, 131, 2, 6),
(2, 131, 2, 8),
(3, 131, 4, 4),
(4, 131, 3, 10),
...
--
-- Дамп данных таблицы `product_variation`
--

INSERT INTO `product_variation` (`id`, `product_id`, `variation_id`, `sku`, `price`, `quantity`, `image`, `stock_status_id`) VALUES
...
(13, 135, 3, 'c17', NULL, NULL, 'ADIDAS_Fruity_Rhythm_dlja_zhenshhin_50_ml_tualetnaja_voda_(edt)_.jpg', 1),
...
(17, 139, 3, 'c26', NULL, NULL, 'ADIDAS_Natural_Vitality_dlja_zhenshhin_50_ml_tualetnaja_voda_(edt)_.jpg', 1),
...
INSERT INTO `stock_status` (`id`, `name`) VALUES
(1, 'В наличии'),
(2, 'Под заказ'),
(3, 'Нет в наличии');
...
INSERT INTO `variation` (`id`, `name`, `description`) VALUES
(1, 'Мыло 170 мл', NULL),
...
--
-- Индексы таблицы `product_attribut`
--
ALTER TABLE `product_attribut`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT для таблицы `product_attribut`
--
ALTER TABLE `product_attribut`
